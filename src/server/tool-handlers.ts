 ...
 * @returns Tool result
 */
export async function handleGenerate3DModel(args: any) {
  try {
 ...
 * @returns Tool result
 */
export async function handleCheckStatus(args: any) {
  try {
 ...
 * @returns Tool result
 */
export async function handleDownload(args: any) {
  try {
